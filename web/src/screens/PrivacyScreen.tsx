            ...
            <main className="max-w-3xl mx-auto px-6 mt-10">
                <article className="bg-white border border-slate-100 rounded-3xl p-8 md:p-12 shadow-sm">
                    <h1 className="text-2xl md:text-3xl font-black text-slate-900 leading-tight mb-4">
                        Политика в отношении обработки персоначеских данных
                    </h1>
                    ...
                    <div className="space-y-6 text-sm text-slate-600 leading-relaxed font-normal">
                        ...
                        <section>
                            ...
                            <p className="mb-3">
                                Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Гольцевым Никитой Сергеевичем (далее — Оператор).
                            </p>
                            <p className="mb-3">
                                1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.
                            </p>
                            <p>
                                1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://choozi.ru" className="text-primary hover:underline font-semibold">https://choozi.ru</a>.
                            </p>
                        </section>

                        {/* 2. Основные понятия */}
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">2. Основные понятия, используемые в Политике</h2>
                            <ul className="list-disc pl-5 space-y-2">
                                ...
                                <li><strong>Веб-сайт</strong> — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://choozi.ru" className="text-primary hover:underline font-semibold">https://choozi.ru</a>.</li>
                                ...
                                <li><strong>Персональные данные</strong> — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="https://choozi.ru" className="text-primary hover:underline font-semibold">https://choozi.ru</a>.</li>
                                ...
                                <li><strong>Пользователь</strong> — любой посетитель веб-сайта <a href="https://choozi.ru" className="text-primary hover:underline font-semibold">https://choozi.ru</a>.</li>
                        ...
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">3. Основные права и обязанности Оператора</h2>
                            <p className="font-extrabold text-slate-700 mb-1">3.1. Оператор имеет право:</p>
                            ...
                            <p className="font-extrabold text-slate-700 mb-1">3.2. Оператор обязан:</p>
                        ...
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">4. Основные права и обязанности субъектов персональных данных</h2>
                            <p className="font-extrabold text-slate-700 mb-1">4.1. Субъекты персональных данных имеют право:</p>
                            <ul className="list-disc pl-5 space-y-1 mb-3">
                            ...
                            <p className="font-extrabold text-slate-700 mb-1">4.2. Субъекты персональных данных обязаны:</p>
                            <ul className="list-disc pl-5 space-y-1 mb-3">
                        ...
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">5. Принципы обработки персональных данных</h2>
                            <ul className="list-disc pl-5 space-y-1">
                        ...
                        {/* 6. Цели обработки */}
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">6. Цели обработки персональных данных</h2>
                            <div className="overflow-x-auto border border-slate-100 rounded-2xl bg-slate-50 p-4 font-medium text-xs space-y-3">
                                <div>
                                    <p className="font-extrabold text-slate-800">Цель обработки:</p>
                                    <p>предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте.</p>
                                </div>
                                <div className="border-t border-slate-200/50 pt-2">
                                    <p className="font-extrabold text-slate-800">Персональные данные:</p>
                                    <p>электронный адрес.</p>
                                </div>
                                <div className="border-t border-slate-200/50 pt-2">
                                    <p className="font-extrabold text-slate-800">Правовые основания:</p>
                                    <p>договоры, заключаемые между оператором и субъектом персональных данных.</p>
                                </div>
                                <div className="border-t border-slate-200/50 pt-2">
                                    <p className="font-extrabold text-slate-800">Виды обработки персональных данных:</p>
                                    <p>Сбор, запись, систематизацию, накопление, хранение, уничтожение и обезличивание персональных данных. Отправка информационных писем на адрес электронной почты.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        {/* 7. Условия обработки */}
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">7. Условия обработки персональных данных</h2>
                            <ul className="list-disc pl-5 space-y-1">
                        ...
                        {/* 8. Порядок сбора, хранения... */}
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">8. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
                            <p className="mb-3">
                            ...
                            <p className="mb-3">
                                8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <a href="mailto:nikita.goltseff@yandex.ru" className="text-primary hover:underline font-semibold">nikita.goltseff@yandex.ru</a> с пометкой «Актуализация персональных данных».
                            </p>
                            <p className="mb-3">
                                8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством.
                            </p>
                            <p className="mb-3">
                                Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <a href="mailto:nikita.goltseff@yandex.ru" className="text-primary hover:underline font-semibold">nikita.goltseff@yandex.ru</a> с пометкой «Отзыв согласия на обработку персональных данных».
                            </p>
                            <p className="mb-3">
                        ...
                        {/* 9. Перечень действий */}
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">9. Перечень действий, производимых Оператором с полученными персональными данными</h2>
                            <p className="mb-3">
                        ...
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">10. Трансграничная передача персональных данных</h2>
                            <p className="mb-3">
                        ...
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">11. Конфиденциальность персональных данных</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-base font-black text-slate-800 mb-3">12. Заключительные положения</h2>
                            <p className="mb-3">
                                12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a href="mailto:nikita.goltseff@yandex.ru" className="text-primary hover:underline font-semibold">nikita.goltseff@yandex.ru</a>.
                            </p>
                            <p className="mb-3">
                                12.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика действует бессрочно до замены ее новой версией.
                            </p>
                            <p>
                                12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://choozi.ru/privacy" className="text-primary hover:underline font-semibold">https://choozi.ru/privacy/</a>.
                            </p>
                        </section>
                    </div>

                    {/* Quick Support Badge */}
                    <div className="mt-12 p-6 bg-slate-50 border border-slate-100 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            <p className="font-extrabold text-slate-800 text-sm">Есть вопросы по защите данных?</p>
                            <p className="text-xs text-slate-400">Напишите нам, и мы ответим в течение 24 часов.</p>
                        </div>
                        <a
                            href="mailto:nikita.goltseff@yandex.ru"
                            className="px-5 py-3 rounded-xl bg-slate-900 text-white font-extrabold text-xs text-center flex items-center justify-center gap-1.5 hover:bg-slate-800 transition-colors"
                        >
                            <Mail size={14} />
